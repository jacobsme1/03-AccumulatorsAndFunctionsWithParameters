...
#                SimpleTurtle and Square
#
#          -- Write the names of three METHODs that Circle objects have:
#                move_by, fill_color, clone
#
...
#            draws the window and all the objects drawn on it.
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            at the end of your code, so you can exit the window after everything else has run.
#
